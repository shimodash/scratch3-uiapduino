    ...
    render () {
        return (
            <ConnectionModalComponent
                ...
                // 接続状態を表す小さなバッジの絵。指定が無ければ上流どおり Bluetooth になる。
                // Scratch Link を使う拡張機能 (micro:bit / EV3 / WeDo / Go Direct) は
                // これを持たないので、従来どおり Bluetooth マークのままになる。
                connectionBadgeIconURL={this.state.extension && this.state.extension.connectionBadgeIconURL}
